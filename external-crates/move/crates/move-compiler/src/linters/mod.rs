...
use crate::{
    ...
    linters::{
        ...
        double_comparisons::DoubleComparisonCheck, empty_if_no_else::EmptyIfNoElse,
        empty_loop::EmptyLoop, eq_op::EqualOperandsCheck, excessive_nesting::ExcessiveNesting,
        freezing_capability::WarnFreezeCapability, ifs_same_cond::ConsecutiveIfs,
        impossible_comparisons::ImpossibleDoubleComparison,
        ...
        redundant_boolean_expressions::RedundantBooleanExp,
    ...
    (
        ...
        vec![
            ...
            WarningFilter::code(
                Some(LINT_WARNING_PREFIX),
                LinterDiagnosticCategory::Complexity as u8,
                REDUNDANT_BOOLEAN_EXP_DIAG_CODE,
