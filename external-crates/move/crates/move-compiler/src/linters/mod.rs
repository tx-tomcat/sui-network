...
use crate::{
    ...
    linters::double_comparisons::DoubleComparisonCheck, typing::visitor::TypingVisitor,
};
...
pub const LINTER_DOUBLE_COMPARISON_DIAG_CODE: u8 = 16;
...
pub fn linter_visitors(level: LintLevel) -> Vec<Visitor> {
    match level {
        ...
        LintLevel::Default | LintLevel::All => {
            vec![double_comparisons::DoubleComparisonCheck::visitor(
